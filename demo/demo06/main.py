...
# YOLOv9準備
net = cv2.dnn.readNet('model/yolov9_n_wholebody34_0100_1x3x640x640.onnx')
...
async def start_camera():
    ...
    camera_stream = await js.navigator.mediaDevices.getUserMedia(media_constraints)
...
async def process_frames():
    ...
    while is_running:
        ...
        outputs = net.forward(output_names[0])
...
# stop_camera関数をJavaScriptから呼び出せるようにする
