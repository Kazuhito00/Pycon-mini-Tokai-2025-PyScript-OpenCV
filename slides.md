...
# デモ：YOLOX(Tiny)による物体検出

<br>
<br>

<iframe id="liveframe_demo_04"
        style="width:85%; height:77%; border:1px solid #ccc; border-radius:8px;"
        src="demo/demo04/initial_page.html"
        sandbox="allow-scripts allow-same-origin">
</iframe>
...
<div style="display: flex; gap: 10px; justify-content: center;">
<button onclick="document.getElementById('liveframe_demo_04').src='demo/demo04/demo.html'" style="padding: 4px 20px; font-size: 16px; cursor: pointer;">
▶️ Run the Demo
</button>
<button onclick="(function(){const iframe=document.getElementById('liveframe_demo_04');try{iframe.contentWindow.stopCamera();}catch(e){}setTimeout(()=>{iframe.src='demo/demo04/initial_page.html';},200);})()" style="padding: 4px 20px; font-size: 16px; cursor: pointer;">
🔄 Reset
</button>
</div>
<br>　　　　　　　　　　　モデル取得元：https://github.com/Kazuhito00/YOLOX-ONNX-TFLite-Sample
...
# デモ：YOLOv9-Wholebody25 物体検出

<br>
<br>

<iframe id="liveframe_demo_05"
        style="width:85%; height:77%; border:1px solid #ccc; border-radius:8px;"
        src="demo/demo05/initial_page.html"
        sandbox="allow-scripts allow-same-origin">
</iframe>
...
<div style="display: flex; gap: 10px; justify-content: center;">
<button onclick="document.getElementById('liveframe_demo_05').src='demo/demo05/demo.html'" style="padding: 4px 20px; font-size: 16px; cursor: pointer;">
▶️ Run the Demo
</button>
<button onclick="(function(){const iframe=document.getElementById('liveframe_demo_05');try{iframe.contentWindow.stopCamera();}catch(e){}setTimeout(()=>{iframe.src='demo/demo05/initial_page.html';},200);})()" style="padding: 4px 20px; font-size: 16px; cursor: pointer;">
🔄 Reset
</button>
</div>
<br>　　　　　　　　　　　モデル取得元：https://github.com/PINTO0309/PINTO_model_zoo/tree/main/459_YOLOv9-Wholebody25
...
# デモ：YOLO-Wholebody34 物体検出

<br>
<br>

<iframe id="liveframe_demo_06"
        style="width:85%; height:77%; border:1px solid #ccc; border-radius:8px;"
        src="demo/demo06/initial_page.html"
        sandbox="allow-scripts allow-same-origin">
</iframe>
...
<div style="display: flex; gap: 10px; justify-content: center;">
<button onclick="document.getElementById('liveframe_demo_06').src='demo/demo06/demo.html'" style="padding: 4px 20px; font-size: 16px; cursor: pointer;">
▶️ Run the Demo
</button>
<button onclick="(function(){const iframe=document.getElementById('liveframe_demo_06');try{iframe.contentWindow.stopCamera();}catch(e){}setTimeout(()=>{iframe.src='demo/demo06/initial_page.html';},200);})()" style="padding: 4px 20px; font-size: 16px; cursor: pointer;">
🔄 Reset
</button>
</div>
<br>　　　　　　　　　　　モデル取得元：https://github.com/PINTO0309/PINTO_model_zoo/tree/main/471_YOLO-Wholebody34
